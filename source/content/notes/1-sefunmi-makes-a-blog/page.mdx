import { NoteHeading, NoteContent } from "@/components/ui/typography";
import { NoteMetadata } from "@/components/ui/NoteMetadata";
...
<NoteHeading id={`random-note-heading-1-sefunmi-makes-a-blog`} title={title} />
<NoteMetadata date={dateStr} category="General" />
...
- arbitrary reflections that sound profound at 3 AM but look ridiculous in daylight, and
