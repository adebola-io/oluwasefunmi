...
export const paintings: Painting[] = [
  {
    ...
    details: "The Mona Lisa is a half-length portrait painting by Italian artist Leonardo da Vinci. Considered an archetypal masterpiece of the Italian Renaissance, it has been described as 'the best known, the most visited, the most written about, the most sung about, the most parodied work of art in the world'. The painting's novel qualities include the subject's expression, which is frequently described as enigmatic, the monumentality of the composition, the subtle modelling of forms, and the atmospheric illusionism.",
    color: "#4a5d4e"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "Often called the 'Mona Lisa of the North', this tronie depicts a girl wearing an exotic dress and a large pearl earring.",
    medium: "Oil on canvas",
    dimensions: "44.5 cm × 39 cm (17.5 in × 15.4 in)",
    location: "Mauritshuis, The Hague",
    style: "Dutch Golden Age",
    details: "Girl with a Pearl Earring is an oil painting by Dutch Golden Age painter Johannes Vermeer. It is a tronie, a Dutch 17th-century description of a 'head' that was not intended to be a portrait. It depicts a European girl wearing an exotic dress, an oriental turban, and what was thought to be a very large pearl as an earring. In 2014, Dutch astrophysicist Vincent Icke raised doubts about the material of the earring and argued that it looks more like polished tin than pearl.",
    color: "#2f4f4f"
  },
  {
    id: 6,
    ...
    description: "A golden-flecked depiction of a couple embracing, wrapped in elaborate golden robes.",
  ...
  },
  {
    ...
    description: "A complex and enigmatic composition showing the Spanish royal family with the artist himself at work.",
    medium: "Oil on canvas",
  ...
  },
  {
    ...
    description: "Part of the Sistine Chapel ceiling, depicting the Biblical creation narrative where God gives life to Adam.",
    medium: "Fresco",
    dimensions: "280 cm × 570 cm (110 in × 220 in)",
    location: "Sistine Chapel, Vatican City",
    style: "High Renaissance",
    details: "The Creation of Adam is a fresco painting by Italian artist Michelangelo, which forms part of the Sistine Chapel's ceiling, painted c. 1508–1512. It illustrates the Biblical creation narrative from the Book of Genesis in which God gives life to Adam, the first man. The fresco is part of a complex iconographic scheme and is chronologically the fourth in the series of panels depicting episodes from Genesis.",
    color: "#a0522d"
  },
  {
    id: 10,
    ...
    details: "Guernica is a large oil painting on canvas by Spanish artist Pablo Picasso completed in June 1937. The painting, which uses a palette of gray, black, and white, is regarded by many art critics as one of the most moving and powerful anti-war paintings in history. It depicts the suffering of people and animals wrought by violence and chaos. Prominent in the composition are a gored horse, a bull, screaming women, dismemberment, and flames.",
    color: "#2f4f4f"
  },
  {
    id: 11,
  ...
  },
  {
    ...
    description: "A surrealist masterpiece featuring melting watches in a dreamlike landscape.",
    medium: "Oil on canvas",
    dimensions: "24 cm × 33 cm (9.5 in × 13 in)",
    location: "Museum of Modern Art, New York City",
    style: "Surrealism",
    details: "The Persistence of Memory is a 1931 painting by artist Salvador Dalí, and one of the most recognizable works of Surrealism. First shown at the Julien Levy Gallery in 1932, since 1934 the painting has been in the collection of the Museum of Modern Art (MoMA) in New York City, which received it from an anonymous donor. It is widely recognized and frequently referenced in popular culture, and sometimes referred to by more descriptive titles, such as 'Melting Clocks', 'The Soft Watches' or 'The Melting Watches'.",
    color: "#6b8e23"
  },
  {
    id: 13,
    ...
    description: "An iconic depiction of rural American values, showing a farmer and his daughter in front of their farmhouse.",
    medium: "Oil on beaverboard",
    dimensions: "78 cm × 65.3 cm (30.7 in × 25.7 in)",
    location: "Art Institute of Chicago, Chicago",
    style: "Regionalism",
    details: "American Gothic is a 1930 painting by Grant Wood in the collection of the Art Institute of Chicago. Wood was inspired to paint what is now known as the American Gothic House in Eldon, Iowa, along with 'the kind of people [he] fancied should live in that house'. It depicts a farmer standing beside his daughter – often mistakenly assumed to be his wife. The figures were modeled by Wood's sister Nan Wood Graham and their dentist Dr. Byron McKeeby.",
    color: "#556b2f"
  },
  {
    id: 14,
    ...
    description: "A group portrait of a militia company, notable for its effective use of light and shadow.",
    medium: "Oil on canvas",
    dimensions: "363 cm × 437 cm (143 in × 172 in)",
    location: "Rijksmuseum, Amsterdam",
    style: "Baroque",
    details: "Militia Company of District II under the Command of Captain Frans Banninck Cocq, also known as The Shooting Company of Frans Banning Cocq and Willem van Ruytenburch, but commonly referred to as The Night Watch, is a 1642 painting by Rembrandt van Rijn. It is in the collection of the Amsterdam Museum but is prominently displayed in the Rijksmuseum as the best-known painting in its collection. The Night Watch is one of the most famous Dutch Golden Age paintings.",
    color: "#1a1a1a"
  },
  {
    id: 15,
    ...
    description: "A pioneering pointillist work showing Parisians relaxing by the Seine.",
    medium: "Oil on canvas",
    dimensions: "207.6 cm × 308 cm (81.7 in × 121.3 in)",
    location: "Art Institute of Chicago, Chicago",
    style: "Pointillism",
    details: "A Sunday Afternoon on the Island of La Grande Jatte painted in 1884, is Georges Seurat's most famous work. It is a leading example of the pointillist technique, executed on a large canvas. Seurat's composition includes a number of Parisians at a park on the banks of the River Seine.",
    color: "#556b2f"
  },
  {
    id: 16,
    ...
    description: "A moody depiction of a late-night diner, capturing urban isolation and loneliness.",
    medium: "Oil on canvas",
    dimensions: "84.1 cm × 152.4 cm (33.1 in × 60.0 in)",
    location: "Art Institute of Chicago, Chicago",
    style: "Social Realism",
    details: "Nighthawks is a 1942 oil on canvas painting by Edward Hopper that portrays four people in a downtown diner late at night as viewed through the diner's large glass window. The light coming from the diner illuminates a darkened and deserted urban streetscape. It has been described as Hopper's best-known work and is one of the most recognizable paintings in American art. Within months of its completion, it was sold to the Art Institute of Chicago for $3,000.",
    color: "#006400"
  },
  {
    id: 17,
    ...
    description: "The painting that gave its name to the Impressionist movement, showing the harbor of Le Havre at sunrise.",
    medium: "Oil on canvas",
    dimensions: "48 cm × 63 cm (18.9 in × 24.8 in)",
    location: "Musée Marmottan Monet, Paris",
    style: "Impressionism",
    details: "Impression, Sunrise is a painting by Claude Monet first shown at what would become known as the 'Exhibition of the Impressionists' in Paris in April, 1874. The painting is credited with inspiring the name of the Impressionist movement. Impression, Sunrise depicts the port of Le Havre, Monet's hometown. It is now displayed at the Musée Marmottan Monet in Paris.",
    color: "#ff8c00"
  },
  {
    id: 18,
    ...
    description: "A surrealist self-portrait with the artist's face obscured by a floating green apple.",
    medium: "Oil on canvas",
  ...
  },
  {
    ...
    description: "A triptych depicting heaven, earth, and hell, filled with fantastical creatures and symbolism.",
    medium: "Oil on oak panels",
    dimensions: "220 cm × 389 cm (87 in × 153 in)",
    location: "Museo del Prado, Madrid",
    style: "Northern Renaissance",
    details: "The Garden of Earthly Delights is the modern title given to a triptych oil painting on oak panel painted by the Early Netherlandish master Hieronymus Bosch, between 1490 and 1510, when Bosch was between 40 and 60 years old. It has been housed in the Museo del Prado in Madrid since the year 1939.",
    color: "#556b2f"
  },
  {
    id: 23,
    ...
    description: "An iconic woodblock print depicting a massive wave towering over boats with Mount Fuji in the background.",
  ...
  },
  {
    ...
    description: "A revolutionary proto-Cubist work depicting five nude women in a brothel, which challenged traditional perspectives.",
    medium: "Oil on canvas",
    dimensions: "243.9 cm × 233.7 cm (96 in × 92 in)",
    location: "Museum of Modern Art, New York City",
    style: "Proto-Cubism",
    details: "Les Demoiselles d'Avignon is a large oil painting created in 1907 by the Spanish artist Pablo Picasso. The work, part of the permanent collection of the Museum of Modern Art, portrays five nude female prostitutes in a brothel on Carrer d'Avinyó, a street in Barcelona. Each figure is depicted in a disconcerting confrontational manner and none is conventionally feminine. The figures are adolescent in appearance and are shown with angular and disjointed body shapes.",
    color: "#d2691e"
  },
  {
    id: 27,
    ...
    description: "One of Van Gogh's most famous still-life series, depicting vibrant sunflowers in various stages of life.",
    medium: "Oil on canvas",
    dimensions: "92.1 cm × 73 cm (36.3 in × 28.7 in)",
    location: "National Gallery, London",
    style: "Post-Impressionism",
    details: "Sunflowers is the title of two series of still life paintings by the Dutch painter Vincent van Gogh. The first series, executed in Paris in 1887, depicts the flowers lying on the ground, while the second set, made a year later in Arles, shows a bouquet of sunflowers in a vase. In the artist's mind both sets were linked by the name of his friend Paul Gauguin, who acquired two of the Paris versions.",
    color: "#ffd700"
  },
  {
    id: 28,
    ...
    description: "A depiction of Christ as Salvator Mundi, which became the most expensive painting ever sold at auction.",
    medium: "Oil on walnut panel",
    dimensions: "65.7 cm × 45.4 cm (25.9 in × 17.9 in)",
    location: "Abu Dhabi (disputed/unknown)",
    style: "High Renaissance",
    details: "Salvator Mundi is a painting by Italian Renaissance artist Leonardo da Vinci dated to c. 1500. Long thought to be a copy of a lost original veiled with overpainting, it was rediscovered, restored, and included in a major Leonardo exhibition at the National Gallery, London, in 2011–12. Although most leading scholars have considered it to be an original work by Leonardo, this attribution has been disputed by other specialists, some of whom posit that he only contributed certain elements.",
    color: "#1e3a5f"
  },
  {
    id: 29,
